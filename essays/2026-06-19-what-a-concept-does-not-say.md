...
The numbering earns its place immediately. An algorithm can then say which obligations it uses ("requires `Monoid<T, Op>` including S1") which distinguishes the algorithms that reassociate
